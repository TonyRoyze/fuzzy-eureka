...
const WhatsAppButton: React.FC = () => {
  ...
  const phoneNumber = "+64123456789"; // Replace with actual WhatsApp business number
  const message = encodeURIComponent(
    "Hello! I'm interested in learning more about your educational consulting services.",
  );
    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        <motion.a
          ...
          className="flex items-center justify-center w-16 h-16 bg-whatsapp-500 hover:bg-whatsapp-600 text-white rounded-full shadow-lg transition-colors duration-200"
        ...
        <motion.div
          className="absolute inset-0 rounded-full border-2 border-whatsapp-500"
          animate={{
            scale: [1, 1.5, 1],
            opacity: [0.7, 0, 0.7],
          }}
